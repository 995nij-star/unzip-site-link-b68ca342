...
import { Loader2, Search, CheckCircle, XCircle, Clock, Eye, Banknote, Calendar, X } from "lucide-react";
...
export default function AdminWithdrawals() {
  const { user } = useAuth();
  const { requests, isLoading, approveRequest, rejectRequest } = useAdminWithdrawalRequests();
  ...
  if (isLoading) {
    return (
      <AdminLayout title="Withdrawal Requests" description="Loading...">
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-border hover:bg-transparent">
                  ...
                  <TableHead className="text-muted-foreground font-rajdhani">UPI ID</TableHead>
                ...
                {filteredRequests.length === 0 ? (
                  ...
                  filteredRequests.map((request) => (
                    <TableRow key={request.id} className="border-border">
                      ...
                      <TableCell>
                        <span className="font-orbitron text-destructive">
            ...
            <div className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-background/50 rounded-lg">
                  ...
                  <p className="font-orbitron text-destructive">
              ...
              <div className="p-3 bg-background/50 rounded-lg">
                ...
                <p className="font-mono text-foreground">{selectedRequest.upi_id}</p>
              </div>

              {selectedRequest.account_holder_name && (
                <div className="p-3 bg-background/50 rounded-lg">
                  <p className="text-xs text-muted-foreground mb-1">Account Holder Name</p>
                  <p className="font-rajdhani text-foreground">{selectedRequest.account_holder_name}</p>
                </div>
              )}
