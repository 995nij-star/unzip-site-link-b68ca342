...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "sheen bg-gradient-to-r from-primary to-[hsl(var(--neon-purple))] text-primary-foreground shadow-[0_4px_18px_-4px_hsl(var(--neon-blue)/0.45)] hover:shadow-[0_8px_28px_-6px_hsl(var(--neon-blue)/0.6)] hover:-translate-y-0.5",
        destructive:
          "sheen bg-destructive text-destructive-foreground shadow-[0_4px_18px_-6px_hsl(var(--destructive)/0.5)] hover:bg-destructive/90 hover:-translate-y-0.5",
        outline:
          "border border-input bg-background/60 backdrop-blur-sm hover:bg-accent/10 hover:text-accent-foreground hover:border-[hsl(var(--neon-blue)/0.5)]",
        secondary:
